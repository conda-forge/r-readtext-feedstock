...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-readtext-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11462&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-readtext-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-readtext` can be installed with:

```
conda install r-readtext
```

It is possible to list all of the versions of `r-readtext` available on your platform with:
